Algoritmo calcular_edad_tres_personas
	...
	Leer año_actual
	// Persona 1
	Escribir "Digite el año de nacimiento de la primera persona:";
	Leer año_nac1
	edad1 <- año_actual - año_nac1
	// Persona 2
	Escribir "Digite el año de nacimiento de la segunda persona:";
	Leer año_nac2
	edad2 <- año_actual - año_nac2
	// Persona 3
	Escribir "Digite el año de nacimiento de la tercera persona:";
	Leer año_nac3
